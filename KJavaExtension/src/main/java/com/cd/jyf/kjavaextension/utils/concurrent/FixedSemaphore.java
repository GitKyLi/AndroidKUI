package com.cd.jyf.kjavaextension.utils.concurrent;
...
/**
 * {@link  java.util.concurrent.Semaphore}  state  is can  change  by  {@link Semaphore#release(int)}
 */
public class FixedSemaphore {


    final Sync sync;

    public FixedSemaphore(int permits) {
        this(false, permits);
    }

    public FixedSemaphore(boolean isFair, int permits) {
        this.sync = isFair ? new FairSync(permits) : new NoFairSync(permits);
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        protected final boolean tryReleaseShared(int releases) {
            for (; ; ) {
                ...
                if (next > permits) {
                    throw new Error("permits  has  a  max  limit  :" + permits);
                }
